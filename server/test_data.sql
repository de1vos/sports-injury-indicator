...
INSERT INTO player (team_id, nation_id, player_first_name, player_last_name, player_position, player_age, player_height, player_weight, player_photo, player_kit_number, player_injury_risk, player_risk_factor_1, player_risk_factor_2, player_risk_factor_3)
VALUES (1, 1, 'Zlatan', 'Ibrahimovic', 'Forward', 25, '195 cm', '95 kg', 'link.to.zlatan.photo.com', 11, 0.51, 'Age', 'High workload', 'Contact sport');

-- Player seasons (player_season_id: 1=Isak 2025, 2=Kane 2025, 3=Zlatan 2025)
...
INSERT INTO player_season (player_id, player_season_year, player_season_appearences, player_season_minutes, player_season_fouls_drawn, player_season_fouls_commited, player_season_duels_total, player_season_tackles, player_season_yellow_cards, player_season_red_cards, player_season_goals, player_season_assists, player_season_dribbles_attempts, player_season_games_missed)
VALUES (2, 2025, 28, 2100, 40, 25, 75, 15, 5, 1, 22, 10, 90, 3);

INSERT INTO player_season (player_id, player_season_year, player_season_appearences, player_season_minutes, player_season_fouls_drawn, player_season_fouls_commited, player_season_duels_total, player_season_tackles, player_season_yellow_cards, player_season_red_cards, player_season_goals, player_season_assists, player_season_dribbles_attempts, player_season_games_missed)
VALUES (3, 2025, 20, 1500, 35, 18, 60, 12, 4, 0, 10, 5, 80, 8);

-- Player injuries (FK is now player_season_id, not player_id)
...
VALUES (1, 0.52, 'GW29', 0.73, 0.14, 0.96, 0.08, 0.55, 0.32, 0.81, 0.47, 0.62, 0.19, 0.88, 0.03, 0.71, 0.44, 0.57, 0.29, 0.93, 0.66, 0.12, 0.84, 0.39, 0.75, 0.21, 0.58, 0.90, 0.43, 0.07, 0.68, 0.35, 0.82, 0.16, 0.94, 0.50, 0.27, 0.79, 0.61, 0.04, 0.48);
...
VALUES (2, 1, '2026-04-25'::date, '17:30:00', 2001, 'Anfield');

INSERT INTO next_match (away_team_id, home_team_id, next_match_date, next_match_time, next_match_fixture_id, next_match_venue)
VALUES (1, 2, '2026-04-27'::date, '14:00:00', 2002, 'Tottenham Hotspur Stadium');
